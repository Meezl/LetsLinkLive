...
<html lang="en">
    ...
    <head>
        ...
        <title>Lets Link Live | Teacher Login</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Lets Link Live</strong> Teacher Login</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login to the teacher panel</h3>
                            ...
                            <div class="form-bottom">
                            	<i style="color:#F00; font-style:normal; font-size:14px"><?php echo validation_errors(); ?></i>
                
								<?php 
                                $attributes = array('id' => 'loginForm', 'role' => 'form', 'method' => 'post', 'class' => 'login-form', 'name' => 'loginForm');
                                echo form_open('Teacher/redirectafterAuth', $attributes) 
								...
								<!--<form id="loginForm" role="form" method="post" class="login-form">-->
			                        ...
			                        <button type="submit" style="background-color: #4aaf51" class="btn">Sign in!</button>
			                    </form>
		                    </div>
                        </div>
                    </div>
